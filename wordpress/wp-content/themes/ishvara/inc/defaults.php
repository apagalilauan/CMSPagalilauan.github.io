...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			...
			'fixed_side_content_background_color' => '#fbb533',
			'fixed_side_content_text_color' => '#333333',
			'fixed_side_content_link_color' => '#71116e',
			...
			'content_title_color' => '',
			'blog_header_bg_color' => '#71116e',
			'blog_header_bg_s_color' => '#333333',
			'blog_header_title_color' => '#fbb533',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#333333',
			'blog_header_button_bg' => '#fbb533',
			'blog_header_button_hover' => '#333333',
			'blog_header_button_hover_bg' => '#fbb533',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => '#fbb533',
			'sidebar_widget_text_color' => '#333333',
			'sidebar_widget_link_color' => '#71116e',
			'sidebar_widget_link_hover_color' => '#ffffff',
			'sidebar_widget_title_color' => '#ffffff',
			'footer_widget_background_color' => '#71116e',
			'footer_widget_text_color' => '#ffffff',
			'footer_widget_link_color' => '#fbb533',
			'footer_widget_link_hover_color' => '#ffffff',
			'footer_widget_title_color' => '#fbb533',
			'footer_background_color' => '#fbb533',
			'footer_text_color' => '#333333',
			'footer_link_color' => '#71116e',
			...
			'form_button_background_color' => '#fbb533',
			'form_button_background_color_hover' => '#fbb533',
			'form_button_text_color' => '#333333',
			'form_button_text_color_hover' => '#333333',
			'back_to_top_background_color' => '#fbb533',
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			'font_body' => 'Open Sans',
			'font_body_category' => '',
			'font_body_variants' => '300,regular,600,700,800',
			...
			'font_top_bar_variants' => '300,regular,600,700,800',
			...
			'font_blog_header_text' => 'Open Sans',
			'font_blog_header_text_category' => '',
			'font_blog_header_text_variants' => '300,regular,600,700,800',
			...
			'font_heading_3' => 'Anton',
			'font_heading_3_category' => '',
			'font_heading_3_variants' => 'regular',
			'heading_3_weight' => '400',
			...
			'font_footer_variants' => '300,regular,600,700,800',
			'footer_weight' => '600',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Anton:regular|Permanent+Marker:regular|Open+Sans:300,regular,600,700,800' );
